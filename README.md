...
- **Свістельник О. С., Чепюк Л. О.** Теоретичні основи побудови мікропроцесорної
  ...
  <br>Українська робота з побудови ІВС контролю мікроклімату. Галузь інша
  (поліграфія, не теплиця), але структура системи «датчики → передавання →
  програмна обробка» і постановка задачі близькі.

Профільні українські фахові видання категорії Б, куди тематично лягає ця робота:
...
Це чесний перелік меж застосовності, а не список недоліків.
...
https://github.com/<ваш-акаунт>/greenhouse-ims-ml
```
